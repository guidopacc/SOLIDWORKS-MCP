...
**SolidWorks MCP** = Model Context Protocol server that enables AI agents (Claude) to automate SolidWorks design workflows programmatically.
...
# Connect via stdio in Claude or other MCP client
```
...
**Maintained by:** Claude + Codex + Contributors
**Last Updated:** 2026-04-07
