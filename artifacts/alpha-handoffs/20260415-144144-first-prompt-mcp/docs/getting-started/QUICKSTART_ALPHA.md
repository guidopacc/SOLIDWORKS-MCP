...
3. report project status
4. report current document state

That confirms the client sees the current public alpha tool and prompt surfaces, not the broader planned history.
