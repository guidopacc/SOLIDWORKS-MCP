...
5. only then run a small modeling flow
...
Those checks tell you whether the client can see the server and its current public alpha guidance layer before you spend time on CAD-specific debugging.
