...
9. `docs/architecture/ALPHA_DISTRIBUTION_PLAN.md`
10. `docs/architecture/SECOND_MACHINE_VALIDATION.md`
11. `docs/architecture/SECOND_MACHINE_VALIDATION_REPORT.md`
12. `docs/architecture/PACKAGING_READINESS_DECISION.md`
13. `docs/planning/PROJECT_STATE.md`
14. `docs/planning/NEXT_STEPS.md`
15. `docs/planning/DECISIONS.md`
...
2. evaluate whether a first Resource MCP or a second small prompt adds more value after `safe_modeling_session`
