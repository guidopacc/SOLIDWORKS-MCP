...
- `receiver-validated`
  - the alpha handoff package has passed one controlled receiver-side dry-run focused on orientation and setup clarity
- `installer-grade`
...
- `receiver-validated`: pending until a receiver dry-run is completed
- `installer-grade`: no
