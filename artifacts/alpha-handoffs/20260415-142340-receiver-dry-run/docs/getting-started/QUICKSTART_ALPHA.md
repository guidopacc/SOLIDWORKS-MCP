...
3. report current document state

That confirms the client sees the current public alpha surface, not the broader planned history.

## 6. First safe prompts
...
## 9. Optional instruction snippet
