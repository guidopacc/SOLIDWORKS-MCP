...
- use `public_alpha_boundary` as initial static boundary context when the host exposes it
...
- the prompt can consume `public_alpha_boundary` as initial static boundary context when available
