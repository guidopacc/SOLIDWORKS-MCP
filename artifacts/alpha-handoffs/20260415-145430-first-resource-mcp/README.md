...
- first public alpha resource surface for read-only current session context
...
If your client supports MCP resources, `current_document_state` is the first read-only resource to preload session context without adding CAD capability.
