...
- how to verify the first public resource is visible to the client
...
5. get current document state
6. only then run a small modeling flow
...
- first public resource discovery validated locally: yes
