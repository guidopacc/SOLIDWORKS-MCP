...
- first public alpha resource surface exposed by default
...
10. `docs/architecture/ALPHA_DISTRIBUTION_PLAN.md`
11. `docs/architecture/SECOND_MACHINE_VALIDATION.md`
12. `docs/architecture/SECOND_MACHINE_VALIDATION_REPORT.md`
13. `docs/architecture/PACKAGING_READINESS_DECISION.md`
14. `docs/planning/PROJECT_STATE.md`
15. `docs/planning/NEXT_STEPS.md`
16. `docs/planning/DECISIONS.md`
...
5. get current document state or read `solidworks://document/current-state`
...
2. evaluate whether a second small resource or a second small prompt adds more value after `current_document_state`
